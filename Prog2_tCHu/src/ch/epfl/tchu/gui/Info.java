...
public final class Info {
     ...
     * @param count amount of the card (for plural/singular)
     ...
     *
     * @param playerNames players in a draw
     * @param points      amount of points in which they draw
     ...
     *
     * @param count amount of ticket kept
     ...
     *
     * @param count amount of tickets drawn
     ...
     *
     * @param route        route attempted to be claimed
     * @param initialCards cards used to claim
     ...
     *
     * @param cardCount card of the player
     ...
     *
     * @param points      winner's points
     * @param loserPoints loser's points
